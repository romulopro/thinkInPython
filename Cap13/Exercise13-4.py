...
def print_unknown_words(list_of_words_on_tale, list_of_words_of_dict):
    list_not_in_dict = list(set(list_of_words_on_tale) - set(list_of_words_of_dict))
    for word in list_not_in_dict:
        print(word)
    return None
...
if __name__ == '__main__':
  ...
  for word in dict_of_words:
      list_of_words_of_dict.append(word[:-1])
  dict_of_words.close()
  ...
  fin.close()  
  print_unknown_words(sorted(list_of_words_on_tale), (list_of_words_of_dict))
